##Functions which let you link a matrix and its inverse, which will only be calculated once and cached

## makeCacheMatrix is a function of x of type matrix, which returns a cache matrix object. This cache object lets us 
